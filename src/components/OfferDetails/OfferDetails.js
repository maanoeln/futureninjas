...
export class OfferDetails extends Component {
    ...
    takeOffer = (id) => {
        axios.put(`https://us-central1-labenu-apis.cloudfunctions.net/futureNinjasOne/jobs/${id}/take`).then(response => {
    ...
    giveUpOffer = (id) => {
        axios.put(`https://us-central1-labenu-apis.cloudfunctions.net/futureNinjasOne/jobs/${id}/giveup`).then(response => {
        ...
        return (
            <OfferDetailsContainer>
                ...
                <ValueDueContainer>
                    ...
                    <Typography variant='h6' color='primary' >Formas e pagamento:</Typography>
                ...
                <GeneralContainer>
                    <Button variant='contained' color='secondary' size='large' onClick={() => this.updateTaken(details.id)}>{taken}</Button>
                </GeneralContainer>
